        ...
        <style>
            * {
            ...
            .profile-avatar {
                ...
                height: 200px;
                /* Adjust the height to make it a circle */
                border-radius: 50%;
                /* This makes it a circle */
                overflow: hidden;
                /* Hides any part of the image that exceeds the circle */
                display: flex;
            ...
            .profile-avatar img {
                width: 100%;
                /* Makes sure the image stretches to fit the container */
                height: 100%;
                /* Makes sure the image stretches to fit the container */
                object-fit: cover;
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <div class="menu-list">
                    <div class="menu-item">
                        <a href="{{ route('user.dashboard') }}" class="menu-link active">
        ...
        <header class="header">
            ...
            <div class="user-menu">
                ...
                <div class="user-info">
                    ...
                    <span class="user-role">Futsal Pro Member</span>
                </div>
            </div>
        </header>
        ...
        <main class="main-content">
            <!-- Bookings View -->
            <div id="bookings-view" class="view @if(Route::is('user.dashboard')) active @endif">
                            ...
                            <table class="bookings-table">
                                ...
                                <tbody>
                                    @foreach ($bookings as $booking)
                                        <tr>
                                            <td><i
                                                    class="fas fa-futbol futsal-icon"></i>{{ $booking['futsal']['futsal_name'] }}
                                            </td>
...
@push('scripts')
    ...
    <script>
        ...
        //  @if(Route::is('user.dashboard')) onload="showView('bookings-view')" @elseif(Route::is('user.profile')) onload="showView('profile-view')" @endif
