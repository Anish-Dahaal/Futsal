    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="{{ route('getShowFutsal') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Show Futsals</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Show Futsals</h6>
                </nav>
        ...
        <div class="col-lg-10">
            <div class="row">
                ...
                <div class="col-xl-12 mt-4 show-futsal">
                    <div class="card futsal-show-container">
                        <div class="card-header futsal-show-header">{{ __('Futsal Details') }}</div>
                        <div class="card-body">
                            @if ($futsals->isEmpty())
                                <p>No futsals added yet.</p>
                            @else
                                <div class="table-responsive">
                                    <table class="table table-bordered futsal-table">
                                        <thead>
                                            <tr>
                                                <th>Futsal Name</th>
                                                <th>Location</th>
